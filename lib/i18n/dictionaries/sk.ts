  ...
  search: {
    ...
    voice: {
      ...
      package: {
        ...
        missing_seller_snapshot: "Finalizovaná faktúra nemá uložené údaje dodávateľa.",
        unknown_direction: "Doklad má neznámy smer.",
        duplicate_path: "Dva súbory by v balíku skončili na tom istom mieste.",
        unsafe_path: "Nebezpečná cesta v balíku.",
        empty_package: "Balík by neobsahoval nič.",
        too_many_invoices: "Príliš veľa dokladov naraz.",
        too_many_files: "Príliš veľa súborov naraz.",
        package_too_large: "Balík by bol príliš veľký. Skúste kratšie obdobie.",
        file_too_large: "Jeden zo súborov je príliš veľký.",
        verification_missing_file: "Kontrola hotového balíka našla chýbajúci súbor.",
        verification_hash_mismatch: "Kontrola hotového balíka našla nesúhlasiaci odtlačok.",
        verification_missing_manifest: "V hotovom balíku chýba manifest.",
        unexpected_error: "Balík sa nepodarilo vytvoriť.",
      },
    },
  },
